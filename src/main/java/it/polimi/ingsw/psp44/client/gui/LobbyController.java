...
public class LobbyController  implements ILobbyView, Initializable {
    ...
    public void newJoin(Message joinOrNew) {
        ...
        LobbyView.launch(LobbyView.class);
    }
    ...
    public void startGame(ActionEvent actionEvent){
        ...
        if (isNewGame.get()){
            ...
            body = BodyFactory.toJoinGame(nicknameText.get(), Integer.parseInt(numberOfPlayersText.get()));
        }
        else {

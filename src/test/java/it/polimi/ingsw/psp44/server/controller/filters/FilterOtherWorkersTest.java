...
public class FilterOtherWorkersTest {

    private Board gameBoard;
    private Filter filterOtherWorkers;

    @Before
    public void setUp() {
        gameBoard = new Board();
        filterOtherWorkers = new FilterOtherWorkers();
    ...
    public void filter() {
        ...
        filterOtherWorkers.filter(startingPosition, actualPositions, gameBoard);
